...
var Sticky = function (_React$PureComponent) {
  ...
  _createClass(Sticky, [{
    ...
    key: 'cssSupport',
    value: function cssSupport(property, value, noPrefixes) {
      var prop = property + ':';
    ...
    value: function render() {
      ...
      return !!this.supportSticky() ? children : __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'div',
...
// exports
exports.locals = {
	"sticky": "index__sticky-2hHaw",
	"child": "index__child-3-vfg"
};
